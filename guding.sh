...
set +e
wget https://ghproxy.com/https://github.com/klever1988/nanopi-openwrt/releases/download/2021-06-09/$board_id$ver.img.gz -O- | gzip -dc > $board_id.img
if [ $? -eq 0 ]; then
	wget https://ghproxy.com/https://github.com/klever1988/nanopi-openwrt/releases/download/2021-06-09/$board_id$ver.img.md5 -O md5sum.txt
